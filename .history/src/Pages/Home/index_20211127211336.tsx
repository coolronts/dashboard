      ...
      <div className="flex-1 mx-6 mt-12">
        ...
        <SplitScreen leftWeight="w-2/3" >
          <Card size="sm" Element={
            <div className="px-6">
              <div className="px-1 tracking-tighter font-sans">
                <p className="font-semibold capitalize text-2xl text-gray-700">Top Staff</p>
                <p className="font-semibold capitalize text-sm text-gray-300">Top Staff</p> 
              </div>
              <Table />
            </div>
          } />
