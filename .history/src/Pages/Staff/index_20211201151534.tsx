        ...
        <>
          ...
          <div className="flex justify-between items-center text-gray-600 font-sans">
            ...
            <div className="w-full flex justify-end items-center">
              ...
              <CalendarButton />
              <div className="w-1/4 bg-white rounded-2xl px-12 tracking-tighter py-6 text-lg shadow font-semibold font-sans">
                <main className="text-lg font-medium tracking-tighter">
                  <Calendar
                    onChange={onChange}
                    showWeekNumbers
                    value={value}
                    selectRange={true}
                    onClickDay={(value) => alert("New date is:" + value)}
                  />
                </main>
              </div>
            </div>
