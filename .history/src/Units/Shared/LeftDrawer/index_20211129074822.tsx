...
const LeftDrawer: React.FC = () => {
  const styles = {
    ...
    menu: "flex flex-col justify-between bg-blue.primary overflow-x-hidden h-36 overflow-y-scroll scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-100",
  };
  const icons = [
