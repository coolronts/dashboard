      ...
      <div className="divide-y divide-gray-300 divide-opacity-60">
        {data.map((item, i) => (
          <div className={styles.row} key={i}>
            ...
            <div className="w-1/5 flex justify-center px-3 items-center">
              <Show className="text-gray-500 text-4xl rounded-full bg-gray-200 p-2 mr-2" />
              <Download className="text-gray-500 text-4xl rounded-full bg-gray-200 p-2" />
            </div>
          </div>
        ))}
      </div>
