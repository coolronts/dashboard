        ...
        <div className=" mb-4 font-semibold font-sans capitalize">
          <div className="px-6">
            ...
            <div className="flex justify-between text-md text-gray-400 pt-1">
              <p>Last 30 days</p>
              <div className="flex">
                {days.map((item, i) => <p key={i} className="px-2 py-1 ring-2 ring-gray-300  text-gray-700 bg-gray-100 ml-4 rounded text-sm font-semibold font-sans tracking-tight">{item}</p>)}
              </div>
            </div>
          </div>
          <MultiLine />
