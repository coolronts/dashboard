...
const Logo: React.FC<IconProps> = ({ Icon, name, color }) => {
  const styles = {
    body:`group my-4 bg-white text-4xl px-12 py-4 bg-white ring-2 ring-gray-300 w-20 rounded-xl flex flex-col items-center justify-around hover:bg-blue-primary cursor-pointer`,
