...
const Logo: React.FC<IconProps> = ({ Icon, name, color }) => {
  ...
  const styles = {
    body:`relative group my-4 text-2xl px-12 py-4 bg-red-300 ring-2 ring-gray-300 w-20 rounded-2xl flex flex-col items-center justify-around hover:bg-blue-primary hover:shadow-2xl cursor-pointer ${active ? 'bg-blue-primary shadow-2xl' :'bg-white'}`,
