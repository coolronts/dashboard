...
const Logo: React.FC<IconProps> = ({ Icon, name, color }) => {
  ...
  const styles = {
    ...
    icon: `${active===name?'bg-green-300 text-white': `bg-${color}-100 text-${color}-900`} rounded-full p-3 group-hover:bg-blue-primary group-hover:text-white ring-4 ring-white`,
