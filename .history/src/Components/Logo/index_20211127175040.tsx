...
const Logo: React.FC<IconProps> = ({ Icon, name, color, active=false }) => {
  ...
  const styles = {
    body:`relative group my-4 text-2xl px-12 py-4 bg-white ring-2 ring-gray-300 w-20 rounded-2xl flex flex-col items-center justify-around hover:bg-blue-primary cursor-pointer ${!active ? "bg-blue-primary" : "bg-white"}`,
