...
const Logo: React.FC<IconProps> = ({ Icon, name, color }) => {
  ...
  const styles = {
    ...
    } relative group my-4 text-2xl px-12 py-4 bg-white ring- ring-gray-300 w-20 rounded-3xl flex flex-col items-center justify-around hover:bg-blue-primary hover:shadow-2xl cursor-pointer `,
    name: `${
