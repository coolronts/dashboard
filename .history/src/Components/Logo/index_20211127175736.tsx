...
const Logo: React.FC<IconProps> = ({ Icon, name, color, active=false }) => {
  ...
  const styles = {
    ...
    icon: `${active ? 'bg-blue-primary text-white':''}rounded-full p-3 bg-${color}-100 text-${color}-900 group-hover:bg-blue-primary group-hover:text-white ring-4 ring-white`,
