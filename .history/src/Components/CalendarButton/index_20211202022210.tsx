...
const CalendarButton: React.FC<props> = ({ text = "9-15 Sep,2020" }) => {
  const styles = {
    icon: "text-2xl p-1 text-gray-400 bg-gray-200 rounded-full font-bold hover:bg-gray-300 hover:text-gray-600 cursor-pointer",
    calendarIcon:
      "text-xl ml-4 text-gray-300 hover:text-gray-600 cursor-pointer",
  };
  return (
    <div className="font-semibold font-sans h-20 bg-white px-8 flex justify-center items-center rounded-2xl shadow ">
