...
const CalendarButton: React.FC<props> = ({ text = "9-15 Sep,2020" }) => {
  ...
  return (
    <div className="text-2xl font-semibold font-sans h-24 bg-white px-2 flex justify-content items-center rounded-2xl shadow ">
      <ArrowLeft className={styles.icon} />
      <div className="flex px-8 font-sans">
        <Calendar className={styles.calendarIcon} />
        <h1 className="px-4 text-lg text-gray-500 ">{text}</h1>
      </div>
