...
const Tags: React.FC<dataProps> = ({
  ...
  const styles = {
    body: `flex justify-center items-center ring-2 rounded-xl w-36 text-center py-1 text-xs font-bold font-sans capitalize
    ${
  ...
  return (
    <div className={styles.body}>
      {type && type.toLowerCase() === "done" && (
        <Done className="text-xl font-900 rounded-full bg-green-500 text-white" />
      )}
