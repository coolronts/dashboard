...
const DropDown: React.FC<DropDownProps> = ({ items, inputType, children }) => {
  const styles = {
    body: "relative bg-white px-3 py-2 w-60 shadow-xl rounded-2xl text-gray-400 ring-4 ring-white",
