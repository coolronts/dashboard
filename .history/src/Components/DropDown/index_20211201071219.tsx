...
const DropDown: React.FC<DropDownProps> = ({ items }) => {
  const styles = {
    body: "bg-white px-3 py-2 w-80 shadow-xl rounded-2xl text-gray-400 ring-4 ring-white",
    icon: "text-2xl p-1 bg-gray-200 rounded-full font-bold hover:bg-gray-300 hover:text-gray-600 cursor-pointer",
    optionsBody:
      "bg-gray-100 w-80 absolute bottom-0 rounded-xl shadow divide-y-2 divide-gray-400 ",
    option:
