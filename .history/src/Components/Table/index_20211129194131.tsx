...
const Table: React.FC<TableProps> = ({
  ...
  const styles = {
    ...
    row: `flex text-sm items-center text-center font-semibold font-sans tracking-tight py-3 flex justify-between px-2`,
    text: `text-base text-gray-500 ${headings && `w-1/${headings.length}`}`,
    body: `w-full h-full divide-solid divide-y divide-gray-300 divide-opacity-60 border-gray-200 bg-red-400 ${
      border && "border-2"
    }  `,
  };
