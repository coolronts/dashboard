...
const Table: React.FC<TableProps> = ({
  ...
  const styles = {
    ...
    row: `flex text-sm items-center text-center font-semibold font-sans tracking-tight py-3 flex justify-between`,
    text: `text-base text-gray-500 ${headings && `w-1/${headings.length}`}`,
    body: `w-full divide-solid divide-y divide-gray-300 divide-opacity-60 border-gray-200 ${
      border && "border-2"
    }  `,
  };
